...
# Group the data by 'Region' and calculate the sum of numerical columns.  I chose sum, because I want to know the data by region.
...
```
```{r}
head(Merged_Data_Long,20) #Show head for further verfication - first 20 rows
```
