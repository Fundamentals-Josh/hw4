...
# Group the data by 'Region' and calculate the sum of numerical columns.  I chose sum, because I want to know the data totals by region for deaths and average for life expectancy.  
